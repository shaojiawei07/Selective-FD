...
def generate_softlabel(args, model_list, device, global_dataset, batch_size):
    ...
    with torch.no_grad():
        ...
        for j in range(10):
            ...
            weighted_softlabel = softlabel * torch.reshape(mini_batch_ensemble_label[:,j], (-1,1) ).to(device)

            mini_batch_softlabel +=  weighted_softlabel#/ 10.0

            #print(weighted_softlabel,"weighted_softlabel")
...
def main():
    ...
    global_dataset = MNIST10Clients2ClassSelectedProxyDataset_softlabel() #MNIST4FedMD10Clients(proxy_dataset = True, dataset_path = "./utils/MNISTwithProxyDataset.pth")
    ...
    for i in range(10):
        # dataset preparation
        train_dataset = MNIST4KuLSIFandFedMD10Clients2Class(client_index = i,
